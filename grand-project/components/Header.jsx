      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <Link href="/" className="flex items-center">
            <Image src="/chef_logo.png" alt="Chef Paxto Logo" width={40} height={40} className="mr-2" />
        ...
        <nav className="hidden lg:flex space-x-6 items-center">
          ...
          {session ? (
            <>
              ...
              <Link href="/dashboard/profile" className={navItemClass("/profile")}>Profile</Link>
              <button onClick={handleSignOut} className="text-red-500 cursor-pointer hover:text-red-600 transition">Sign Out</button>
            </>
          ) : (
            <>
        ...
        <nav className="lg:hidden px-4 pb-4 space-y-2 bg-white shadow-md">
          ...
          {session ? (
            <>
              ...
              <Link href="/dashboard/profile" className={mobileNavItemClass("/profile")}>Profile</Link>
              <button onClick={handleSignOut} className="block cursor-pointer text-red-500 hover:text-red-600 transition">Sign Out</button>
            </>
          ) : (
            <>
